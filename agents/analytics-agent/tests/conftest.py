...
def mock_bridges():
    ...
    def make_mock_tool(name: str, description: str, required_params: list[str], all_params: dict[str, str]):
    ...
    data_mcp.get_langchain_tools = AsyncMock(return_value=[
        make_mock_tool(
            "execute_read_query",
    ...
    data_mcp.invoke = AsyncMock(side_effect=lambda tool_name, params: {
        "status": "success",
        "rows": [
    ...
    salesforce_mcp.get_langchain_tools = AsyncMock(return_value=[
        make_mock_tool(
    ...
    salesforce_mcp.invoke = AsyncMock(side_effect=lambda tool_name, params: {
        "status": "success",
        "account": {
    ...
    payments_mcp.get_langchain_tools = AsyncMock(return_value=[
        make_mock_tool(
            "get_payment_summary",
    ...
    payments_mcp.invoke = AsyncMock(side_effect=lambda tool_name, params: {
        "status": "success",
    ...
    news_mcp.get_langchain_tools = AsyncMock(return_value=[
        make_mock_tool(
            "search_company_news",
    ...
    news_mcp.invoke = AsyncMock(side_effect=lambda tool_name, params: {
        "status": "success",
